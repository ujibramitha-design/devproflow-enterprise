    ...
    <div className={cn("flex items-center gap-3", collapsed && "justify-center")}>
      <div className="relative" style={{ perspective: "600px" }}>
        ...
        <div className="animate-float relative">
          ...
          >
            <div className="absolute inset-x-0 top-0 h-1/2 rounded-t-2xl" style={{ background: "linear-gradient(to bottom, rgba(255,255,255,0.25), transparent)" }} />
            <div className="absolute -bottom-[3px] -right-[3px] size-11 rounded-2xl" style={{ background: "oklch(0.35 0.10 260)", zIndex: -1 }} />
            <span className="relative text-[18px] font-black tracking-tighter text-primary-foreground drop-shadow-sm">D</span>
        ...
        <div className="absolute -bottom-0.5 -right-0.5 z-10 size-3 rounded-full border-2 border-card bg-emerald-400 dark:bg-emerald-500">
          <div className="absolute inset-0 rounded-full bg-emerald-400 dark:bg-emerald-500 animate-pulse" />
        </div>
      </div>
      {!collapsed && (
        <div className="overflow-hidden animate-slide-in-right">
          <h1 className="text-[16px] font-black tracking-tight text-foreground leading-none">DEVPro FLOW</h1>
          <div className="mt-1 flex items-center gap-1.5">
            <div className="h-px w-3 bg-gradient-to-r from-primary/60 to-transparent" />
            <p className="text-[9px] font-bold tracking-[0.2em] uppercase text-muted-foreground/60">Enterprise Hub</p>
          </div>
        </div>
      )}
    </div>
