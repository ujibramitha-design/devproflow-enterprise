    ...
    <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
      {metrics.map((metric, index) => (
        <Link 
          key={metric.title} 
          href={metric.href}
          className="group relative block overflow-hidden rounded-2xl bg-card p-5 shadow-sm ring-1 ring-border/30 transition-all duration-500 hover:shadow-xl hover:ring-primary/20 hover:-translate-y-1 animate-fade-in-up" 
        ...
        >
          ...
          <div className="relative">
            ...
            <div className="mt-3 flex items-center gap-2">
              ...
              <span className="text-[11px] text-muted-foreground/70">{metric.period}</span>
            </div>
          </div>
