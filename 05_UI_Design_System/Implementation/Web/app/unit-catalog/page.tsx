          ...
          <div className="space-y-4">
            ...
            <div className="grid gap-4 md:grid-cols-3">
              ...
              <div className="p-4 rounded-xl bg-emerald-500/5 border border-emerald-500/10">
                <h3 className="font-semibold text-emerald-600 mb-2">WhatsApp Integration</h3>
                <p className="text-sm text-devpro-muted-foreground">Instant inquiry with one click</p>
              </div>
