    ...
    <div className="rounded-2xl bg-card shadow-sm ring-1 ring-border/30">
      ...
      <div className="flex items-center justify-between px-6 py-5">
        ...
        <div className="flex items-center gap-2">
          ...
          <Link href="/aplikasi" className="flex h-8 items-center gap-1.5 rounded-lg bg-primary/[0.08] px-3 text-[12px] font-bold text-primary transition-all duration-300 hover:bg-primary/15">
            Lihat Semua
